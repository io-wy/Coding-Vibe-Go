...
跨项目通用能力，建议安装到 `~/.claude/skills/`。见 `templates/global-skills/`。

```bash
cp templates/global-skills/deep-thinking.md ~/.claude/skills/
cp templates/global-skills/prompt-engineering.md ~/.claude/skills/
cp templates/global-skills/technical_writing.md ~/.claude/skills/
cp templates/global-skills/devex-tooling.md ~/.claude/skills/
cp templates/global-skills/coordinator-delegation.md ~/.claude/skills/
cp templates/global-skills/competitive-analysis.md ~/.claude/skills/
```
...
- Global: 跨项目通用，放在 `templates/global-skills/`，建议用户全局安装
